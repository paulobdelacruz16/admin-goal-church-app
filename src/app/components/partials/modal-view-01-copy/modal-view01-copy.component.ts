...
@Component({
  selector: 'app-modal-view01-copy',
  templateUrl: './modal-view01-copy.component.html',
  styleUrls: ['./modal-view01-copy.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ModalView01CopyComponent implements OnInit {
  ...
  createForm() {
    ...
    console.log('dataModel', this.requestForm);
  ...
  getVal(val: string) {
		return (this.configService as any)[val];
	}
